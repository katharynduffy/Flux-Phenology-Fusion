...
[do so here.](https://cran.rstudio.com/)
...
```
*You may have to type 'Y' a few times if there are dependencies that you don't have which need to be installed.*


You're good to go!

Let's go ahead and launch our RMarkdown Notebook for tomorrow:
[Click this link to direct you to the GitHub repo for our workshop.](https://github.com/katharynduffy/Flux-Phenology-Fusion)

1.  Click on the 'clone or download button' and download the repo as a zip (or if you're a regular github user just git clone)

In your Console paste the following code:
```
file.edit('Live Coding Data Fusion.Rmd')
